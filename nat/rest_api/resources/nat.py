...
@nat_ns.route('/floatingIP', methods=['GET','POST'])
@nat_ns.route('/floatingIP/<id>', methods=['GET','PUT','DELETE'])
class Nat_FloatingIP(Resource):
    @nat_ns.param("Floating IP", "Floating IP to add", "body", type="string", required=True)
    @nat_ns.response(202, 'Floating IP correctly added.')
    @nat_ns.response(400, 'Bad request.')
    @nat_ns.response(500, 'Internal Error.')
    def post(self):
        """
    ...
    @nat_ns.response(200, 'Floating IP retrieved.')
    @nat_ns.response(500, 'Internal Error.')
    ...
    @nat_ns.param("Floating IP", "Floating IP to update", "body", type="string", required=True)
    @nat_ns.response(202, 'Floating IP correctly updated.')
    @nat_ns.response(400, 'Bad request.')
    @nat_ns.response(500, 'Internal Error.')
    def put(self, id):
        """
...
@nat_ns.route('/floatingIP/<id>/privateAddress', methods=['GET','PUT'])
class Nat_FloatingIP_PrivateAddress(Resource):
    @nat_ns.response(200, 'Floating IP private address retrieved.')
    @nat_ns.response(500, 'Internal Error.')
    def get(self, id=None):
        """
    ...
    @nat_ns.param("Floating IP private address", "Floating IP private address to update", "body", type="string", required=True)
    @nat_ns.response(202, 'Floating IP private address correctly updated.')
    @nat_ns.response(400, 'Bad request.')
    @nat_ns.response(500, 'Internal Error.')
    def put(self, id):
        """
...
@nat_ns.route('/floatingIP/<id>/publicAddress', methods=['PUT'])
class Nat_FloatingIP_PublicAddress(Resource):
    @nat_ns.response(200, 'Floating IP public address retrieved.')
    @nat_ns.response(500, 'Internal Error.')
    def get(self, id=None):
        """
    ...
    @nat_ns.param("Floating IP public address", "Floating IP public address to update", "body", type="string", required=True)
    @nat_ns.response(202, 'Floating IP public address correctly updated.')
    @nat_ns.response(400, 'Bad request.')
    @nat_ns.response(500, 'Internal Error.')
    def put(self, id):
        """
