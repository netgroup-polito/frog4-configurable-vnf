...
class Interface_ifEntry(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            natController.configure_interface(json_data)
    ...
    def get(self, id=None):
        ...
        try:
            natController = NatController()
            if id is None:
                json_data = json.dumps(natController.get_interfaces())
            else:
                json_data = json.dumps(natController.get_interface(id))
            resp = Response(json_data, status=200, mimetype="application/json")
            return resp
    ...
    def put(self, id):
        ...
        try:
            natController = NatController()
            json_data = json.loads(request.data.decode())
            natController.update_interface(id, json_data)
            return Response(status=202)
    ...
    def delete(self, id):
        ...
        try:
            natController = NatController()
            natController.reset_interface(id)
            return Response(status=202)
...
class Interface_ifEntry_Ipv4Configuration(Resource):
    ...
    def get(self, id):
        ...
        try:
            natController = NatController()
            json_data = json.dumps(natController.get_interface_ipv4Configuration(id))
            resp = Response(json_data, status=200, mimetype="application/json")
            return resp
    ...
    def put(self, id):
        ...
        try:
            natController = NatController()
            json_data = json.loads(request.data.decode())
            natController.update_interface_ipv4Configuration(id, json_data)
            return Response(status=202)
...
class Interface_ifEntry_Ipv4Configuration_Address(Resource):
    ...
    def get(self, id):
        ...
        try:
            natController = NatController()
            json_data = json.dumps(natController.get_interface_ipv4Configuration_address(id))
            resp = Response(json_data, status=200, mimetype="application/json")
            return resp
    ...
    def put(self, id):
        ...
        try:
            ...
            natController.update_interface_ipv4Configuration_address(id, address)
            return Response(status=202)
...
class Interface_ifEntry_Ipv4Configuration_Netmask(Resource):
    ...
    def get(self, id):
        ...
        try:
            natController = NatController()
            json_data = json.dumps(natController.get_interface_ipv4Configuration_netmask(id))
            resp = Response(json_data, status=200, mimetype="application/json")
            return resp
    ...
    def put(self, id):
        ...
        try:
            ...
            natController.update_interface_ipv4Configuration_netmask(id, netmask)
            return Response(status=202)
...
class Interface_ifEntry_Ipv4Configuration_DefaultGw(Resource):
    ...
    def get(self, id):
        ...
        try:
            natController = NatController()
            json_data = json.dumps(natController.get_interface_ipv4Configuration_mac_address(id))
            resp = Response(json_data, status=200, mimetype="application/json")
            return resp
...
class Interface_ifEntry_Ipv4Configuration_MacAddress(Resource):
    ...
    def get(self, id):
        ...
        try:
            natController = NatController()
            json_data = json.dumps(natController.get_interface_ipv4Configuration_default_gw(id))
            resp = Response(json_data, status=200, mimetype="application/json")
            return resp
    ...
    def put(self, id):
        ...
        try:
            ...
            natController.update_interface_ipv4Configuration_default_gw(id, default_gw)
            return Response(status=202)
