...
class Interface(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            json_data = json.dumps(firewallController.get_interfaces_status())
...
class Interface_ifEntry_Ipv4Configuration(Resource):
    ...
    def put(self, id):
        ...
        try:
            firewallController = FirewallController()
            json_data = json.loads(request.data.decode())
            firewallController.update_interface_ipv4Configuration(id, json_data)
            return Response(status=202)
...
class Interface_ifEntry_Ipv4Configuration_Address(Resource):
    ...
    def put(self, id):
        ...
        try:
            ...
            firewallController.update_interface_ipv4Configuration_address(id, address)
            return Response(status=202)
...
class Interface_ifEntry_Ipv4Configuration_Netmask(Resource):
    ...
    def put(self, id):
        ...
        try:
            ...
            firewallController.update_interface_ipv4Configuration_netmask(id, netmask)
            return Response(status=202)
...
class Interface_ifEntry_Ipv4Configuration_DefaultGw(Resource):
    ...
    def get(self, id):
        ...
        try:
            firewallController = FirewallController()
            json_data = json.dumps(firewallController.get_interface_ipv4Configuration_mac_address(id))
            resp = Response(json_data, status=200, mimetype="application/json")
            return resp
...
class Interface_ifEntry_Ipv4Configuration_MacAddress(Resource):
    ...
    def put(self, id):
        ...
        try:
            ...
            firewallController.update_interface_ipv4Configuration_default_gw(id, default_gw)
            return Response(status=202)
